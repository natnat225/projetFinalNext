...
export default function Page() {
  ...
  return (
    ...
    <div className='grid grid-cols-3 gap-5 rounded-md bg-zinc-800 px-16 py-20'>
      {data
        .filter(game => game.platform === "Web Browser")
        .slice(0, 21)
        .map((game: Game) => (
            ...
            <div className='flex justify-between h-6 justify-center'>
              <p className='text-slate-200'>{game.title}</p>
              <Link href={`/browser/${game.id}`}>
