...
export default function GameDetails({
  ...
  return (
    ...
    <div className="w-full bg-zinc-800w-full bg-zinc-800 h-screen flex flex-col items-center justify-center px-16">
      
      
      <div className="border border-orange-500 rounded-lg flex flex-col bg-zinc-700 h-1/2">
        {loading ? (
          <div className="flex flex-col ">
            {data
              .filter((item) => item.id === parseInt(params.browser))
              .map((game) => (
