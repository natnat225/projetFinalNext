...
<footer
  className="flex flex-col bg-zinc-800 items-center bg-zinc-50 text-center text-surface ">
  <div className="container bg-zinc-800 pt-9">
  ...
  <div className="w-full flex justify-center bg-zinc-800 p-4 text-center">
    © 2024 Copyright:
    <p>Instant Gamers</p>
  </div>
</footer>
